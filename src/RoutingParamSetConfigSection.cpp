...
std::map<std::string, RoutingParamSetConfigSection *>
    g_routingParamSetConfigs[ROUTE_QTY];

RoutingParamSetConfigSection::RoutingParamSetConfigSection(char *nameVal,
                                                           ROUTES routeVal) {
  strcpy(name, nameVal);
  currentGauge = NULL;
  currentParams = NULL;
...
char *RoutingParamSetConfigSection::GetName() { return name; }

CONFIG_SEC_RET RoutingParamSetConfigSection::ProcessKeyValue(char *name,
                                                             char *value) {
...
bool RoutingParamSetConfigSection::IsDuplicate(char *name, ROUTES routeVal) {
  std::map<std::string, RoutingParamSetConfigSection *>::iterator itr =
      g_routingParamSetConfigs[routeVal].find(name);
...
bool RoutingParamSetConfigSection::IsDuplicateGauge(
