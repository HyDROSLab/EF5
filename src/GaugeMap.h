...
class GaugeMap {
	public:
		...
		void AddUpstreamGauge(GaugeConfigSection *downStream, GaugeConfigSection *upStream);
		void GaugeAverage(std::vector<GridNode> *nodes, std::vector<float> *currentValue, std::vector<float> *gaugeAvg);
