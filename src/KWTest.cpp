...
float inflowHydrograph[] = {0.0, 56.633694, 56.633694, 84.950541, 113.267388, 141.584235, 169.901082, 141.584235, 113.267388, 84.950541, 56.633694, 56.633694};
...
void InitializeKW() {
  ...
  for (int currentNode = 0; currentNode < NUM_GRID_CELLS; currentNode++) {
    ...
    currentN->slope = 0.01; //10.0 / currentN->horLen; // We assume a difference in height of 1 meter because we know nothing else
