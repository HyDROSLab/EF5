...
#define DEBUG_LOGF(x, ...) LOGFR(ANSI_COLOR_YELLOW "DEBUG:" __FILE__ "(%i): " ANSI_COLOR_RESET x "\n", __LINE__, __VA_ARGS__)
#define INFO_LOGF(x, ...) LOGFR(ANSI_COLOR_GREEN "INFO:" __FILE__ "(%i): " ANSI_COLOR_RESET x "\n", __LINE__, __VA_ARGS__)
#define WARNING_LOGF(x, ...) LOGFR(ANSI_COLOR_YELLOW "WARNING:" __FILE__ "(%i): " ANSI_COLOR_RESET x "\n", __LINE__, __VA_ARGS__)
#define ERROR_LOG(x) LOGFR(ANSI_COLOR_RED "ERROR:" __FILE__ "(%i): " ANSI_COLOR_RESET x "\n", __LINE__)
#define ERROR_LOGF(x, ...) LOGFR(ANSI_COLOR_RED "ERROR:" __FILE__ "(%i): " ANSI_COLOR_RESET x "\n", __LINE__, __VA_ARGS__)
#else
