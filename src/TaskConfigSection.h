...
private:
  bool styleSet, modelSet, basinSet, precipSet, qpfSet, petSet, outputSet, stateSet, paramsSet, timestepSet, timeStateSet, timeBeginSet, timeWarmEndSet, timeEndSet, caliParamSet, routingParamsSet, routingCaliParamSet, defaultParamsSet, routeSet;
  ...
  char stdGrid[CONFIG_MAX_LEN], avgGrid[CONFIG_MAX_LEN], scGrid[CONFIG_MAX_LEN];
	char actionGrid[CONFIG_MAX_LEN], minorGrid[CONFIG_MAX_LEN], moderateGrid[CONFIG_MAX_LEN], majorGrid[CONFIG_MAX_LEN];
  char actionSDGrid[CONFIG_MAX_LEN], minorSDGrid[CONFIG_MAX_LEN], moderateSDGrid[CONFIG_MAX_LEN], majorSDGrid[CONFIG_MAX_LEN];
